...
public:
    ...
    void proximity(typename pcl::PointCloud<PointT>::Ptr cloud,std::vector<bool>& processed,typename pcl::PointCloud<PointT>::Ptr& cluster, KdTree* tree, float distanceTol,int index);
